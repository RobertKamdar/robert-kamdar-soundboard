...
export default function App() {
  ...
  const beats = [
    ...
    { name: 'SCRATCH', file: '/scratch.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'HILAL 2', file: '/hilal2.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'SAMBA', file: '/samba.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'MIND THE GAP', file: '/mindthegap.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'NGOLO', file: '/ngolo.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'ALLEY', file: '/alley.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'VIRTUOSO', file: '/virtuoso.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'MELODY', file: '/melody.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
    { name: 'KARZZZ', file: '/karzzz.mp3', bpm: '142', moods: ['Aggressive', 'Gritty', 'Minimalistic'], addedAt: '2026-04-18' },
